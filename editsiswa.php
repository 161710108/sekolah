...
<form action="simpaneditsiswa.php" method="post">
 <?php
include ('koneksi.php');
    $id   =$_GET['id'];
...
?>
<center><h3><font face="comic sans ms" color="violet">Edit Data Siswa</font></h3></center>
...
<input type="hidden" name="id" value="<?php echo $data['id'];?>">
  ...
  <input type="text" name="nis" class="form-control"  value="<?php echo $data['nis'];?>"  placeholder="nis" aria-describedby="sizing-addon1" required/>
</div>
<br>
 <div class="input-group input-group-lg">
...
<br>
 <div class="input-group input-group-lg">
  ...
  <input type="radio" name="jk" value="perempuan" value="<?php echo $data['jk'];?>" aria-describedby="sizing-addon1" required/>Perempuan
  <input type="radio" name="jk" value="laki-laki" value="<?php echo $data['jk'];?>" aria-describedby="sizing-addon1" required/>Laki-laki
</div>
<br>
 <div class="input-group input-group-lg">
...
<br>
 <div class="input-group input-group-lg">
  ...
  <input type="text" name="alamat" class="form-control"  value="<?php echo $data['alamat'];?>"  placeholder="alamat" aria-describedby="sizing-addon1" required/>
</div>
<br>
 <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1" name="kelas_id" placeholder="kelas" aria-describedby="sizing-addon1" required/>kelas</span>
