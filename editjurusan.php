...
$data = mysqli_fetch_array($b);
  ?>
    <center><h3><font face="comic sans ms" color="violet">Edit Data Jurusan</font></h3></center>
...
<legend>Edit Data Jurusan</legend>
  ...
  <input type="text" name="jurusan" class="form-control"  value="<?php echo $data['jurusan'];?>"  placeholder="jurusan" aria-describedby="sizing-addon1" required/>
</div>
<br>
<br>
