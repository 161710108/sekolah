...
<ul class="nav nav-pills nav-stacked">
  ...
  <li role="presentation"><a href="lihatdatasiswa.php">Siswa</a></li>
    ...
    <center><h3><font face="comic sans ms" color="violet">Input Data Kelas</font></h3></center>
...
<?php
      ...
      $mhs  = mysqli_query($koneksi,"SELECT * FROM kelas WHERE id");

    ?>
  <div class="input-group input-group-lg">
  <span class="input-group-addon" id="sizing-addon1">Kelas</span>
  <input type="text" name="kelas" class="form-control"  placeholder="Kelas" aria-describedby="sizing-addon1" required/>
</div>
<br>
  <div class="input-group input-group-lg">
...
<br>
 <div class="input-group input-group-lg">
  ...
  <input type="text" name="wali_kelas" class="form-control"  placeholder="Wali_Kelas" aria-describedby="sizing-addon1" required/>
</div>
<br>
<br>
